'''class Hod: 
    def __init__(self):# constructor
        self.name='salman khan' #data member 2 byte
        self.age=53             # 4 byte
        self.empid=1001         # 6 byte total = 12 byte
...
#SI,Factorial,Fibnacci by using class you have to make a program'''
...
'''class NewClass:
    def __init__(self): #constructor declration
...
'''class Student:
    def __init__(self):# constructor
        ...
        # evry data member and it's values stored int he form of {key:value} pair
...
'''class Student:
    ...
    def getdata(self):# instance method
        self.s_mb     = 28282828282 # instance variable
